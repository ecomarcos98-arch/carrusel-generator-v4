...
const buildSlidePrompt = (segment, style, totalSlides) => {
  const stylePrompt = STYLES[style]?.prompt || STYLES.gta.prompt;
...
[CHARACTER DESIGN — USE REFERENCE PHOTO AS MODEL ONLY]
Study the reference photo carefully: note the person's face shape, hairstyle, hair color, skin tone, facial hair, and distinguishing features.
Now REDRAW this person entirely from scratch in the following artistic style: ${stylePrompt}
...
Use bold, clean, high-contrast typography that fits the art style, with a subtle overlay behind it for legibility.
